...
$newimage =  mysqli_real_escape_string($conn, $_POST["newimage"]);
...
$sql = "INSERT INTO move (movieID,movieImg,movieTitle,movieGenre,movieDuration,movieRelDate,movieDirector,movieActors) VALUES ( '$newid','$newimage','$newtitle','$newgenre','$newduration','$newreldate','$newdirector','$newactors')";
